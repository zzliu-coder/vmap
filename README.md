...
- `data/places.json`：唯一的地点主数据。保留原203家米其林覆盖城市餐厅，并新增会安古城11个非米其林口碑点；当前共214处、200处有公开坐标。支持餐厅、景点、咖啡、住宿、购物、交通和其他地点。
...
会安不属于2026越南米其林指南的河内、胡志明市、岘港三城覆盖范围，因此新增的11个会安点位明确作为“本地口碑补充”，不会显示成米其林入选。包括高楼面、白玫瑰、鸡饭、会安法棍、卷食套餐、现代越南菜和草本饮；每个点保留独立来源、OSM坐标来源、预算估算与已核到的 Google Place ID。
